...
import com.example.hyfit_android.databinding.ActivityCommunityMainBinding
...
class CommunityMainActivity : AppCompatActivity(), OnMapReadyCallback, Observer {
