...
import com.example.hyfit_android.databinding.ActivityGoalResultBinding
...
class GoalResultActivity : AppCompatActivity() {
    private lateinit var binding: ActivityGoalResultBinding
    ...
    private var xList = mutableListOf<String>()
      override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityGoalResultBinding.inflate(layoutInflater)
