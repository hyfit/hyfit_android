...
class PostService {
    ...
    fun setGetCommunityProfileView(getCommunityProfileView: GetCommunityProfileView) {
        ...
        fun getAllPostsOfFollowingUsersWithType(
            token: String,
            ...
            val postService = getPostRetrofit().create(PostRetrofitInterface::class.java)
            postService.getAllPostsOfFollowingUsersWithType(token, lastPostId, searchType, size)
                .enqueue(object : Callback<PostPageRes> {
                    override fun onResponse(
                        ...
                        when (val code = resp.code) {
                            ...
                            else -> getAllPostsOfFollowingUsersView.onGetAllPostsOfFollowingUsersWithTypeFailure(
                                code,
                                resp.message
                            )
                        }
        ...
        fun getAllPostsOfAllUsersWithType(
            token: String,
            lastPostId: Long? = null,
            searchType: String? = null,
            size: Int
            ...
            val postService = getPostRetrofit().create(PostRetrofitInterface::class.java)
            postService.getAllPostsOfAllUsersWithType(token, lastPostId, searchType, size)
                .enqueue(object : Callback<PostPageRes> {
                    override fun onResponse(
                        call: Call<PostPageRes>,
                        response: Response<PostPageRes>
